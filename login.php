...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT id, firstname, lastname, staff_id, password, designation FROM staff WHERE staff_id = ?";
        ...
        if($stmt = mysqli_prepare($connection, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $firstname, $lastname, $staff_id, $hashed_password, $usertype) ;
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter StaffId..." name="staff_id">
